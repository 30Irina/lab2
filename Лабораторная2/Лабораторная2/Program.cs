...
namespace Task1
{
    class Program
    {
		...
		{
			Console.WriteLine("----------1----------");
            V4DataArray testArray1 = new V4DataArray("testArray1", System.DateTime.Now, 2, 2, new System.Numerics.Vector2(0.3f, 0.6f), Fv2.TestVectorF);
			...
			testList1.AddDefaults(3, Fv2.TestVectorF);
		...
		static void TestLinq()
		{
			...
			V4DataArray testArray1 = new V4DataArray("testArray1", DateTime.Now, 2, 2, new System.Numerics.Vector2(1.5f, 1f), Fv2.TestVectorF);
            ...
            Console.WriteLine(String.Format("Максимальное значение модуля поля = {0}\n\n", collection1.MaxVal));

            Console.WriteLine("Incr\n");
			foreach (var f in collection1.Incr)
			{
			
				Console.WriteLine($"Расстояние: { System.Numerics.Vector2.Distance(System.Numerics.Vector2.Zero, f.point)}, Точка: {f.point}\n");
